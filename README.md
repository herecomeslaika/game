...
- **📡 联机模式** — 支持本地网络多人对战，实时同步玩家位置、技能释放、伤害计算
...
### 设计理念
采用**极简无底纹设计风格**，所有按钮仅显示彩色文字，移除不必要的装饰元素。

### 核心优化
- **无底纹按钮** — 所有按钮只显示文字，无背景填充、无边框
- **水平布局房间信息** — 房间码和玩家计数并排显示，节省竖向空间
- **更高信息密度** — 玩家列表可显示 5-6 人（优化前 4 人）
- **色彩统一** — 金色(标题) / 绿色(成功) / 蓝色(信息) / 红色(危险) / 灰色(中性)
